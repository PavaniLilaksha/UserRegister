...
public class AdminDetails extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			String sql = "select fname,lname,MNum,email,pass,pass2, from admin where email = '"+user.getEmail()+"'";
			...
			request.getRequestDispatcher("/adminpro.jsp").forward(request,response);
		}
		catch(Exception p){
